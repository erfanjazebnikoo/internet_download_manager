...
import idm.test.com.internetdownloadmanager.model.TasksManagerDBOpenHelper;
...
public class TasksManagerDBController {
    ...
    TasksManagerModel addTask(final String url, final String path) {
        ...
        model.setName(URLUtil.guessFileName(url, null, fileExtenstion));
        model.setUrl(url);
        model.setPath(path);
    ...
    public boolean deleteTask(int id) {
        TasksManagerModel model = new TasksManagerModel();
        return db.delete(TABLE_NAME, TasksManagerModel.ID + "=" + id, null) > 0;
    }
